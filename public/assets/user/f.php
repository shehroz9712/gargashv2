    ...
    <div class="footer-top-wrapper mb-4 d-flex flex-sm-row flex-column gap-sm-0 gap-3 align-items-center justify-content-between">
      ...
      <div class="footer-social-wrapper">
        <ul class="list-unstyled d-flex ps-0 mb-0 gap-2 justify-content-center">
          <li>
            <a href="#" class="text-decoration-none body-color primary-regular-font level-8 d-flex align-items-center gap-3">
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item bg-transparent">
          <h2 class="accordion-header" id="flush-headingOne">
            <button class="accordion-button bg-transparent level-1 sub-font dark-color collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne"> Brands </button>
          </h2>
        ...
        <div class="accordion-item bg-transparent">
          <h2 class="accordion-header" id="service-seciont">
            <button class="accordion-button bg-transparent level-1 sub-font dark-color collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo"> Services </button>
          </h2>
        ...
        <div class="accordion-item bg-transparent">
          <h2 class="accordion-header" id="flush-headingThree">
            <button class="accordion-button bg-transparent level-1 sub-font dark-color collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree"> Contact Us </button>
          </h2>
