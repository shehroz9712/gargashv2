        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="review-performance text-center">
              <h2 class="level-1 heading-font extra-color-6">20 <span>+</span>
              </h2>
              <h4 class="level-4-lg primary-regular-font extra-color-6">Year Experience</h4>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="review-performance text-center">
              <h2 class="level-1 heading-font extra-color-6">50 <span>+</span>
              </h2>
          ...
          <div class="col-sm-6">
            <div class="review-performance text-center">
              <h2 class="level-1 heading-font extra-color-6">100 <span>+</span>
              </h2>
          ...
          <div class="col-sm-6">
            <div class="review-performance text-center">
              <h2 class="level-1 heading-font extra-color-6">106 <span>+</span>
              </h2>
              <h4 class="level-4-lg primary-regular-font extra-color-6">Project Completed</h4>
            </div>
          </div>
        </div>
      </div>
