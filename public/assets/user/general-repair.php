...
<section class="container-fluid general-repair-form-bg overflow-visible vh-100">
  <div class="container h-100 w-100">
    ...
    <img src="assets/img/gr-form-car-collection.png" alt="" class="img-fluid">
  </div>
</section>
<!-- Form Section  End-->
  ...
  <div class="container">
    <div class="row vh-100">
      ...
      <div class="col-md-6 my-auto">
        <img src="assets/img/service-partner-right.png" alt="" class="Chinese-Car-Partner-right-car mt-5" style="max-width: 40rem;">
      </div>
    </div>
  </div>
</section>
...
<section class="container text-center mx-auto 100-vh w-100">
  ...
  <img src="assets/img/services-solution.png" alt="" class="img-fluid">
