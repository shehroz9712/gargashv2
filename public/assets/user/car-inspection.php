    ...
    <div class="row align-items-center white">
      <div class="col-lg-7">
        <div class="experiecne-top-content">
          ...
          <p class="fs-6 fw-light lh-sm text-secondary">Car Inspection & Computer Diagnostics in Dubai For American, German, Japanese, and all Exotic Cars. Discounted Price, Free Pickup & Drop Off, Free Inspection. Call Us For free Pickup.</p>
          <span class="d-flex gap-4">
            <button class="bg-warning border-0 fs-6 fw-semibold px-4 py-2 rounded-3">Call Now</button>
            <button class="bg-transparent border-2 fs-6 fw-semibold px-5 py-2 rounded-3">Our Services</button>
          </span>
        </div>
      </div>
      <div class="col-lg-5">
        <img src="assets/img/car-inspection-hero-right.png" alt="" />
      </div>
    </div>
  </div>
</section>
