...
@section('content')
            ...
            <div class="row align-items-center white">
                <div class="col-lg-7">
                    <div class="experiecne-top-content">
                        ...
                        <p class="fs-6 fw-light lh-sm text-secondary">Specializing in auto body, mechanical and electrical
                            repair and servicing for American, German, Japanese, Chinese, and all luxury cars. Enjoy
                            discounted prices, pickup and drop-off, and a complimentary inspection and estimate. Proud
                            finalists at Automechanika, offering top-tier service you can trust. Call us today for your
                            booking!</p>
                        <span class="d-flex flex-column flex-md-row gap-4">
                            ...
                            <button class="bg-transparent border-3 border-dark btn fs-6 fw-semibold rounded-3">Call
                                Now</button>
                        </span>
                    </div>
                </div>
        ...
        <div class="container h-100 w-100">
            <div class="align-items-center g-2 h-100 justify-content-center row w-100">
                <div class="col-md-6 px-0 text-center">
                    <h2 class="fw-bolder text-black lh-1 responsive-heading-3">Your Effortless <span
    ...
    <section class="container-fluid">
        <div class="row justify-content-center align-items-center g-2">
            <div class="col-md-5">
                <img src="{{asset('assets/user/img/auto-body-services.png')}}" alt="" class="img-fluid" style="margin-left: -1rem;">
            </div>
            <div class="col-md-5 d-flex flex-column gap-2">
                ...
                <span>
                    <p class="fs-6 fw-light lh-sm text-secondary">Looking for comprehensive auto body services in Dubai?
                        You've come to the right place. We provide expert services including accident repair, chassis
                        repair, auto detailing, and more.</p>
                ...
                <h5 class="fs-6 fw-normal">Let us take care of your vehicle with our expert services, ensuring it stays in
                    perfect condition.</h5>
            </div>
            <div class="col-md-2 d-none d-md-block">
                <img src="{{asset('assets/user/img/auto-body-services-tree.png')}}" alt="" class="img-fluid"
                    style="margin-right: 1rem;">
            </div>
        </div>
    </section>
    <!-- gateway-section Start Here  -->
        @include('user.layouts.gateway')
    ...
    <div class="container-fluid mt-5 overflow-hidden">
        <div class="card-slider slide-right-to-left">
            <div class="card card-border-1">
                <img src="{{asset('assets/user/img/slider-img-3.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
                    <h5 class="card-title fs-5 fw-bold main-color"> Car Accident Repair </h5>
                    <p class="card-text fs-6 fw-normal lh-sm text-secondary"> Complete car accident repair solution, either
                        its a small accident or a major one, we at gargash auto center provides dealer alternative quality
                        auto body shop service at a reasonable price. </p>
                </div>
            </div>
            <div class="card card-border-2">
                <img src="{{asset('assets/user/img/slider-img-4.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
            ...
            <div class="card card-border-1">
                <img src="{{asset('assets/user/img/slider-img-5.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
                    <h5 class="card-title fs-5 fw-bold main-color"> Detailing / Polishing / Head Lights Restoration </h5>
                    <p class="card-text fs-6 fw-normal lh-sm text-secondary"> Your car may not be so cleaned from inside, or
                        there can be some kind of smell, or you may want a new look of your car from inside </p>
                </div>
            </div>
            <div class="card card-border-2">
                <img src="{{asset('assets/user/img/slider-img-6.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
                    <h5 class="card-title fs-5 fw-bold text-black"> Wind Screen / Auto Glass Replacement </h5>
                    <p class="card-text fs-6 fw-normal lh-sm text-secondary"> If your cars front or back windscreen is
                        broken, or any door window or a mirror is broken. </p>
                </div>
            </div>
            <div class="card card-border-1">
                <img src="{{asset('assets/user/img/slider-img-7.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
                    <h5 class="card-title fs-5 fw-bold main-color"> Dashboard Repairing / Sun Roof Liner Repair & Fixing
                    </h5>
                    <p class="card-text fs-6 fw-normal lh-sm text-secondary"> Sometimes your car’s dashboard can be damaged
                        because of sunshine and high temperature in uae, or it may be broken due to any reason. </p>
                </div>
            </div>
            <div class="card card-border-2">
                <img src="{{asset('assets/user/img/slider-img-8.png')}}" alt="Card Image" class="p-3" />
                <div class="card-body ">
                    <h5 class="card-title fs-5 fw-bold text-black"> Upholstery / Leather And Fabric Seats Restoration. </h5>
                    <p class="card-text fs-6 fw-normal lh-sm text-secondary"> Complete vehicle restoration service, from
                        accident repair, vehicle exterior repair, and restoration </p>
                </div>
            </div>
