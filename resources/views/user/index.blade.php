...
@section('content')
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            <img src="{{ asset('assets/user/img/bg-frame1.png') }}" alt=""
                                                class="img-fluid frame_img">
                                            <div
                                                class="car-wrapper d-flex flex-column h-100 justify-content-center justify-content-md-between left-0 position-absolute right-0 text-center top-0">
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img1.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <a href="./services/auto-spa">
                                                    <div class="car-text ">
                                                        ...
                                                        <!-- Walid bhai work -->
                                                        <h6
                                                            class="dark-color  heading-font m-0 my-hero-heading index-hero-card-text-font-size">
                                                            <!-- Me Work -->
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img2.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img3.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img4.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img5.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img6.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img7.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img8.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
                                    ...
                                    <div class="banner-sub-img my-banner-sub-img">
                                        <figure class="position-relative my-figure-images-container">
                                            ...
                                            <div
                                                ...
                                                <div class="car-sub-img">
                                                    <figure>
                                                        <img src="{{ asset('assets/user/img/car-img9.png') }}"
                                                            alt="" class="img-fluid">
                                                    </figure>
                                                </div>
                                                <div class="car-text ">
        ...
        <div class="container">
            ...
            <div class="product-slider-wrapper slider-sec">
                <div class="product_slider_main my-product_slider_main">
                    ...
                    <figure class="p-2 pb-0 slide-fig position-relative text-center">
                        <img src="{{ asset('assets/user/img/lamborghini.png') }}" alt=""
                            class="img-fluid w-75 mx-auto">
                    </figure>
                    <figure class="p-2 pb-0 slide-fig position-relative text-center">
                        <img src="{{ asset('assets/user/img/RR.png') }}" alt="" class="img-fluid w-75 mx-auto">
                    </figure>
                    <figure class="p-2 pb-0 slide-fig position-relative text-center">
                        <img src="{{ asset('assets/user/img/Ferrari.png') }}" alt=""
                            class="img-fluid w-75 mx-auto">
                    </figure>
                    <figure class="p-2 pb-0 slide-fig position-relative text-center">
                        <img src="{{ asset('assets/user/img/Ford.png') }}" alt=""
                            class="img-fluid w-75 mx-auto">
                    </figure>
                </div>
            </div>
            ...
            <div class="product_slider_inner mt-4">
                <div class="logo-slider">
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/Jeep Logo.png') }}" alt=""
                            class="img-fluid logo-item">
                    </figure>
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/logo-8.png') }}" alt="" class="img-fluid logo-item">
                    </figure>
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/logo-5.png') }}" alt="" class="img-fluid logo-item">
                    </figure>
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/RR Logo.png') }}" alt=""
                            class="img-fluid logo-item">
                    </figure>
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/Ferrari logo.png') }}" alt=""
                            class="img-fluid logo-item">
                    </figure>
                    <figure class="p-2">
                        <img src="{{ asset('assets/user/img/Ford logo.png') }}" alt=""
                            class="img-fluid logo-item">
                    </figure>
                </div>
            </div>
    ...
    <section class="container d-block d-md-none vh-100 w-100 pb-0 ">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="review-main bg-img-cover img-no-repeat w-100 position-center position-relative">
                        ...
                        <div class="google-review position-absolute left-0">
                            <figure>
                                <img src="{{ asset('assets/user/img/google-review-img.png') }}" alt=""
                                    class="img-fluid">
                            </figure>
                        </div>
                        ...
                        <div class="row align-items-end">
                                ...
                                <div class="review-text pb-4 position-relative" id="main-review">
                                    <a href="#" id="main-review-link" target="_blank">
                                        <div class="review-para pb-4">
                                            <p class="level-7 primary-regular-font extra-color-2"
                                                id="main-review-comment">
                                                I’ve been bringing my car to Gargash Auto for years, and they never
                                                disappoint. The team is always professional, and I know my car is in the
                                                best hands. From routine maintenance to major repairs, they handle
                                                everything with precision. Highly recommend their services!</strong>
                                            </p>
                                        </div>
                                        <div class="review-name-wrapper text-end">
                                            <div class="review-name">
                                                <h4 class="level-4-lg primary-semibold-font extra-color-2"
                                                    id="main-review-name">–Dmitri </h4>
                                            </div>
                                            <ul class="reviews-wrap list-unstyled m-0 p-0 d-flex align-items-center justify-content-end gap-2 mt-2"
                                                id="main-review-rating">
                                                <li class="review-li">
                                        ...
                                        <div class="review-commas position-absolute left-0 right-0 mx-auto">
                                            <figure class="w-fit mx-auto">
                                                <img src="{{ asset('assets/user/img/review-commas.png') }}"
                                                    alt="" class="img-fluid">
                                            </figure>
                                        </div>
                                    </a>
                            ...
                            <div class="col-lg-6">
                                <div class="review-right-wrapper">
                                    <!-- Review 1 -->
                                    <a href="https://www.google.com/maps/contrib/112094789349298792644/reviews/@25.0261676,55.5071691,10z/data=!4m3!8m2!3m1!1e1?hl=en-GB&entry=ttu&g_ep=EgoyMDI1MDMwMi4wIKXMDSoASAFQAw%3D%3D"
                                        target="_blank" class="review-link"
                                        data-comment="Gargash Auto transformed my car care experience. The convenience of their service contract makes it so easy for me to get my car serviced without disrupting my schedule. Plus, their team is always honest and efficient. Truly top-notch service!"
                                        data-name="– Mark R." data-rating="5">
                                        <div class="review-box d-flex align-items-center justify-content-between mb-3">
                                            <div class="review-sub-name">
                                                ...
                                                <p class="level-8 primary-regular-font extra-color-2 mb-0">Satisfied
                                                    Customer</p>
                                            </div>
                                            <div class="review-start-wrap">
                                                <ul
                                                    class="reviews-wrap list-unstyled m-0 p-0 d-flex align-items-center justify-content-end gap-2">
                                                    <li class="review-li">
                                                        <i class="fa-solid fa-star" style="color: #E6B110;"></i>
                                                    </li>
                                                    <li class="level-9 primary-semibold-font secondary-color">(4.7 / 5)
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Review 2 -->
                                    <a href="https://www.google.com/maps/contrib/113581672704880399952/reviews/@23.1118938,80.4932083,4z/data=!3m1!4b1!4m3!8m2!3m1!1e1?hl=en-GB&entry=ttu&g_ep=EgoyMDI1MDMwMi4wIKXMDSoASAFQAw%3D%3D"
                                        target="_blank" class="review-link"
                                        data-comment="I recently had my luxury car serviced at Gargash Auto, and the results were outstanding. Their team treated my car like it was their own, and I could tell they used only the best tools and parts. I’ll definitely continue to trust them with all my vehicle needs."
                                        data-name="– Jasmine P." data-rating="5">
                                        <div class="review-box d-flex align-items-center justify-content-between mb-3">
                                            <div class="review-sub-name">
                                    ...
                                    <!-- Review 3 -->
                                    <a href="https://www.google.com/maps/contrib/117252774557379550002/reviews/@25.1708598,55.3177495,11z/data=!3m1!4b1!4m3!8m2!3m1!1e1?hl=en-GB&entry=ttu&g_ep=EgoyMDI1MDMwMi4wIKXMDSoASAFQAw%3D%3D"
                                        target="_blank" class="review-link"
                                        data-comment="Gargash Auto’s customer service is second to none. From booking the service to receiving my car back in perfect condition, the entire process was seamless. They even took the time to explain the repairs and answer all my questions. I wouldn't trust my car with anyone else."
                                        data-name="– David M." data-rating="5">
                                        <div class="review-box d-flex align-items-center justify-content-between mb-3">
                                            <div class="review-sub-name">
                                    ...
                                    <!-- Review 4 -->
                                    <a href="https://www.google.com/maps/contrib/101997236533537285372/reviews/@40.5203133,26.0415536,4z/data=!3m1!4b1!4m3!8m2!3m1!1e1?hl=en-GB&entry=ttu&g_ep=EgoyMDI1MDMwMi4wIKXMDSoASAFQAw%3D%3D"
                                        target="_blank" class="review-link"
                                        data-comment="The team at Gargash Auto went above and beyond for me. They not only fixed my car efficiently but also provided a detailed inspection and offered helpful tips to keep my vehicle in top condition. It’s clear they truly care about their customers."
                                        data-name="– Ali K." data-rating="5">
