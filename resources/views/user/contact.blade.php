    ...
    <section class="section container-fluid contract-hero ">
        <div class="container d-flex flex-column h-100  justify-content-center text-center w-100">
            <div class="contract-hero-content">
                ...
                <h4 class="fs-5 fw-semibold">We'd love to hear from you and provide assistance for all your car servicing
                    needs.</h4>
            </div>
        </div>
    </section>
            ...
            <div class="gap-4 justify-content-center row">
                <div class="bg-white col-md-4 rounded-4 shadow" style="padding: 35px;">
                    <div>
                        ...
                        <br />
                        <span style="font-size: medium;" class="fw-light lh-sm">Our experts will provide tailored solutions
                            to ensure efficient and secure cloud operations for your organization.</span>
                        <br />
                    </div>
                    <div>
                        <br />
                        <ul class="gap-2 lh-base list-group list-inline">
                            <li>
                                <i class="fa-circle-check fa-solid text-warning"></i> Understand how our API product may
                                fulfill your needs
                            </li>
                            <li>
                                <i class="fa-circle-check fa-solid text-warning"></i> Understand how our API product may
                ...
                <div class="col-md-7 bg-white p-4 rounded-3 shadow">
                    <h3 class="fw-bolder">Send us your <span class="text-warning"> Query</span></h3>
        ...
        <section>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 m-2">
                            <div class="location-card">
                                <img src="{{asset('assets/user/img/location-1.png')}}" class="location-img" alt="Location 1">
                                <div class="location-details">
                                    <p>
                                        <i class="fas fa-map-marker-alt"></i> 16 29th St-Al Quoz Industrial Area<br /> 4 -
                                        Dubai
                                    </p>
                                    <p>
                                        <a href="tel:+971 56 545 8853"><i class="fas fa-phone"></i> +971 56 545 8853</a>
                                    </p>
                                </div>
                        ...
                        <div class="col-md-4 m-2">
                            <div class="location-card">
                                <img src="{{asset('assets/user/img/location-2.png')}}" class="location-img" alt="Location 2">
                                <div class="location-details">
                                    <p>
                                        <i class="fas fa-map-marker-alt"></i> 25.121845 - 55.239942 - Al Quoz Industrial
                                        Area 4 - Dubai
                                    </p>
                                    <p>
                                        <a href="tel:+971 56 545 8853"><i class="fas fa-phone"></i> +971 56 545 8853</a>
                        ...
                        <div class="col-md-4 m-2">
                            <div class="location-card">
                                <img src="{{asset('assets/user/img/location-3.png')}}" class="location-img" alt="Location 3">
                                <div class="location-details">
                                    <p>
                                        <i class="fas fa-map-marker-alt"></i> 208 Amman St - Al Qusais<br /> Industrial
                                        Area 4 - Dubai
                                    </p>
                                    <p>
                                        <a href="tel:+971 56 545 8853"><i class="fas fa-phone"></i> +971 56 545 8853</a>
            ...
            <div class="container py-4" style="height: 75vh;">
                <div class="h-100 w-100 mt-4">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3612.7654729905844!2d55.22656!3d25.109799099999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f6957dcc6da79%3A0x17d16321848b8d94!2s16%2029th%20St%20-%20Al%20Quoz%20-%20Al%20Quoz%20Industrial%20Area%204%20-%20Dubai%20-%20United%20Arab%20Emirates!5e0!3m2!1sen!2s!4v1741388163770!5m2!1sen!2s"
                        frameborder="0" class="h-100 rounded-4 w-100"></iframe>
                </div>
            </div>
            <br />
            <!-- Ifram Sectin  End -->
