  ...
  <div class="container h-100">
    <div class="row align-items-md-center h-100 ">
      <div class="col-md-6 d-flex flex-column gap-2">
        ...
        <a href="{{ route('user.promotions') }}">  <button class="btn fs-6 fw-bold px-4 text-dark w-auto">Avail Your Discount</button></a>
      ...
      <div class="col-md-6">
        <img src="{{asset('assets/user/img/Chinese-Car-hero-right-car.png')}}" alt="" class="img-fluid" loading="lazy">
      </div>
    </div>
</section>
<!-- Hero Section End -->
...
<section class="Chinese-Car-form-bg Chinese-Car-form-bottom-car container-fluid overflow-visible vh-100">
  <div class="container h-100 w-100">
    <div class="align-items-center g-2 h-100 justify-content-center row w-100">
      <div class=" col-md-6 light position-relative white">       @include('user.layouts.partials.form') </div>
      ...
      <div class="col-md-6 my-auto">
        <img src="{{asset('assets/user/img/Chinese-Car-Partner-right-car.png')}}" alt="" class="Chinese-Car-Partner-right-car mt-5" style="max-width: 40rem;">
                ...
                Repair, & Service Solution
						...
						<img src="{{asset('assets/user/img/Maintenance-car.png')}}" alt="">
